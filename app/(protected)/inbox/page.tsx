...
import { listInboxRevisionForAuthor } from "@/server/workflows/approval/queries";
...
export default async function InboxPage() {
  ...
  if (subject.role !== UserRole.EMPLOYEE && subject.role !== UserRole.MANAGER && subject.role !== UserRole.OWNER) {
    notFound();
  }

  const items = await listInboxRevisionForAuthor(subject.userId);
